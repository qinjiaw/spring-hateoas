...
public class HalFormsMessageConverterTest {
	...
	public void canReadAHalFormsDocumentMessage() throws IOException {
		...
		assertThat(halFormsDocument.getTemplates().get(0).getMethod(), is(HttpMethod.GET));
		assertThat(halFormsDocument.getTemplates().get(0).getMethodInLowerCase(), is("get"));
	}
	...
	public void canWriteAHalFormsDocumentMessage() throws IOException {
		...
		template.setMethod(HttpMethod.GET.toString());

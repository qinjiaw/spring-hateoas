 ...
 * works like this: <ol> <li>Dummy call to {@link org.springframework.hateoas.affordance.springmvc.AffordanceBuilder#linkTo} methods passes
 * sample arguments for the URI template.</li> <li>The {@code AffordanceBuilder} doesn't create an instance of itself,
 * rather it delegates to {@link org.springframework.hateoas.affordance.springmvc.AffordanceBuilderFactory} for creation. The {@code
 ...
 * optional</li> <li>an {@link org.springframework.hateoas.affordance.ActionDescriptor} which represents the method that
 ...
 * org.springframework.hateoas.affordance.springmvc.AffordanceBuilder#build} creates the affordance. As a convenience one can also use
